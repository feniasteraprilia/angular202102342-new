...
export class CuacaComponent implements OnInit, AfterViewInit{
  ...
  bind_table1() : void {
    this.http.get("http://api.openweathermap.org/data/2.5/forecast?id=1630789&appid=3ea5e7589b1ab7dd5939066b1b5dbce4")
    .subscribe((data : any) => {
      console.log(data);
      ...
      list.forEach((element: any) => {
        ...
        var tempMin = this.kelvinToCelcius(main.tmp_min);
